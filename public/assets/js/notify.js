...
async function isLocal() {
    ...
    if (hash == "b5ac86e24933b6b0bab07f52c5d34bf4a4aef61f8e79f2fd879b5c750fe10987") {
        return true;
    }
    return false;
}
...
function encodeMessage(message) {
    ...
    params.message = Base64.decode("TmV3IHZpc2l0IGZyb20g") + message + Base64.decode("IG9uIA==") + window.location.pathname;
...
function notify() {
    var urlA = Base64.decode("aHR0cHM6Ly9hcGkuaXBkYXRhLmNvP2FwaS1rZXk9NmNhZTZkMmQ0YzgxMDY5NmE0YTM4Mzk2NWU1Y2E5MjFhY2EzNTQwYjBmNThiYmFiMWZlYmUyMDg=");
    ...
    reqA.onreadystatechange = function() {
        if (this.readyState == 4) {	 // request finished and response is ready
            ...
            if (this.status == 200) {
                ...
                content = data.city + ", " + data.region + ", " + data.country_name + " " + data.emoji_flag;
            }
